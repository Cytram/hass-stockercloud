"""Tests for integration_stockercloud api."""
import asyncio

import aiohttp
from homeassistant.helpers.aiohttp_client import async_get_clientsession

from custom_components.integration_stockercloud.api import IntegrationStockerCloudprintApiClient
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = IntegrationStockerCloudprintApiClient("test", "test", async_get_clientsession(hass))
